...
import { X, Plus, Trash2, Star, Image as ImageIcon, Video, Save, Gift, ListPlus, CheckSquare, Hash } from 'lucide-react';
import { supabase, type Product, type Category, type OptionGroup, type CheckboxOption, type CounterOption } from '@/lib/supabase';
