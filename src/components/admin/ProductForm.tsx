      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-fade-in">
        ...
        <form onSubmit={handleSave} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1.5">السعر (ر.س) *</label>
              <input
                type="number"
                step="0.01"
                value={price}
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1.5">سعر التخفيض (ر.س)</label>
              <input
                type="number"
                step="0.01"
                value={discountPrice}
