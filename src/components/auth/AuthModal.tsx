              ...
              {!done && (
                <>
                  ...
                  <form onSubmit={handleActivate} className="space-y-4">
                    ...
                    <InputField icon={<KeyRound size={18} />} placeholder="كود التفعيل" value={code} onChange={setCode} />
                    <button type="submit" disabled={loading} className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition">
            ...
            <div className="space-y-4">
              {!done && !resetRequested && (
                <form onSubmit={handleRequestReset} className="space-y-4">
                  ...
                  <InputField icon={<Phone size={18} />} placeholder="رقم الهاتف" value={phone} onChange={setPhone} disabled={!!customer} />
                  <button type="submit" disabled={loading} className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition">
              ...
              {!done && resetRequested && (
                <>
                  ...
                  <form onSubmit={handleConfirmReset} className="space-y-4">
                    <div className="flex gap-2">
                      <InputField icon={<KeyRound size={18} />} placeholder="كود التغيير" value={code} onChange={setCode} />
                      <button
                        type="button"
...
function InputField({ icon, placeholder, value, onChange, type = 'text', disabled = false }: {
