...
import { User, KeyRound, Package, ArrowRight, Printer, ChevronLeft, ShoppingBag, Heart, ShoppingCart, Gift, Hash } from 'lucide-react';
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-4 space-y-1 text-sm">
              ...
              {selectedOrder.transfer_code && (
                <div className="flex justify-between"><span className="text-gray-500 flex items-center gap-1"><Hash size={13} /> كود التحويل:</span><span className="font-semibold" dir="ltr">{selectedOrder.transfer_code}</span></div>
              )}
