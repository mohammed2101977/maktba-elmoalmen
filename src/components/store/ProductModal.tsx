...
import { X, ShoppingCart, Star, Check, Gift, Minus, Plus } from 'lucide-react';
import {
  type Product,
...
export default function ProductModal({
  ...
  const selected: SelectedOptions = { groups: selectedGroups, checkboxes: selectedCheckboxes, counters: selectedCounters };
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-fade-in">
        ...
        <div className="grid md:grid-cols-2 gap-6 p-4 sm:p-6">
          ...
          <div className="flex flex-col">
            ...
            <button
              onClick={handleAdd}
              disabled={!product.availability_note && product.stock === 0}
