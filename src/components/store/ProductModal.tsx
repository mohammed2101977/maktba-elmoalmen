...
export default function ProductModal({
  ...
  function setItemQuantity(itemId: string, qty: number) {
    setCheckboxQuantities((prev) => ({ ...prev, [itemId]: Math.min(5, Math.max(1, qty)) }));
  }
...
// A small 1-5 "العدد" stepper shown next to a checkbox item that has a quantity multiplier.
