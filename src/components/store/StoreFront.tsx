  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 py-6">
        {/* Ad banners */}
        {banners.length > 0 && (
          <div className="mb-8 -mx-3 sm:mx-0 px-3 sm:px-0 flex flex-col gap-3">
            {banners.map((banner) => {
              ...
              if (banner.width) containerStyle.maxWidth = `${banner.width}px`;
              if (banner.width) containerStyle.marginLeft = 'auto';
              if (banner.width) containerStyle.marginRight = 'auto';
              ...
              return (
                <div
                  key={banner.id}
                  className={`w-full rounded-2xl overflow-hidden shadow-sm bg-gray-100 ${!banner.height ? 'aspect-[21/6] sm:aspect-[21/5]' : ''}`}
